...
export class AppComponent {
    ...
    generatePdf() {
        ...
        autoTable(doc, {
            ...
            didDrawCell: (data) => {
                ...
                if (data.section === 'body' && data.column.index === 1) {
                    doc.addImage(imgData, 'JPEG', data.cell.x + 10, data.cell.y + 2, 45, 22)
                }
            }
        });
        ...
        autoTable(doc, {
            ...
            head: [
                ['Forma de Pago', 'Condiciones de Pago', 'Fecha de Entrega']
            ],
            body: [
                ['TRANSFERENCIA', '45 DÍAS', '22/04/23'],
        ...
        autoTable(doc, {
            ...
            head: [
                ['Total Items: 1 - Total Productos 60']
            ],
        });
