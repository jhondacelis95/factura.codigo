...
export class AppComponent {
  ...
  xmlajson() {
    // {
    //     "industryName": "PPG INDUSTRIES COLOMBIA LTDA.",
    //     "NIT": "900.007.650-4",
    //     "direccionFacturacion": {
    //         "nombre": "ZH INGENIEROS SAS",
    //         "NIT": "900210398-1"
    //     }
    // }
    ...
    fileInput.addEventListener('change', () => {
      ...
      reader.onload = () => {
        ...
        // console.log(
        //   xmlDoc.querySelector('ExternalReference Description').textContent
        // );
        ...
        // JSON.items = {codigo: xmlDoc2.querySelector('OrderReference').textContent};

        const itemsXML = xmlDoc2.getElementsByTagName('InvoiceLine')[0];
  ...
  generatePdf() {
    ...
    //  ['1', '(5972) ANGULO ACERO 2-1/2" X 1/4" X 6M', 'UND', '60', '168.532,00 $', '10.111.920,00 $'],
